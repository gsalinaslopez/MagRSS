...
if args['layers'] is None:
    args['layers'] = [['dense', '64', 'None', 'None']] 
print(args)


df = nnutils.get_dataframe_from_dir(args['train_dir'])
d = {'SIDEWALK' : 0, 'ROAD' : 1}
df = df.replace(d)
...
linear_est.train(input_fn=lambda: input_fn(df=train,shuffle=True))
result = linear_est.evaluate(input_fn=lambda: input_fn(df=train,shuffle=False))
