...
if args['layers'] is None:
    args['layers'] = [['lstm', '128', '0.001', '0.5', 'True', 'True'],
                      ['lstm', '128', '0.001', '0.5', 'False', 'True'],
                      ['dense', '64', '0.001', '0.5']] 
    args['layers'] = [['lstm', '128', '0.001', '0.5', 'True', 'True'],
                      ['dense', '64', '0.001', '0.5']] 
print(args)
...
train_data_gen = TimeseriesGenerator(train_x.values, train_y, length=100, batch_size=args['batch_size'])
val_data_gen = TimeseriesGenerator(val_x.values, val_y, length=100, batch_size=args['batch_size'])
